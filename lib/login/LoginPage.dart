...
import 'package:fika_app/login/smsPage.dart';
import 'package:fika_app/login/update_password.dart';
import '/login/ForgotPassword.dart';
import '/login/smsPage.dart';
...
// Remember update
                    ...
                    TextButton(
                      onPressed: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => UpgatePasswordPage()));
                      },
                      child: Text(
                        "Update password?",
                ...
                Padding(
                  padding:
                      const EdgeInsets.only(left: 22.0, right: 22.0, top: 15.0),
                  child: InkWell(
                    child: Container(
                      height: 50.0,
  ...
  _emailSignIn() async {
    try {
      if (_formKey.currentState!.validate()) {
        ...
        print("User Logged in: ${_signInQilganUser.email}");
        if (_signInQilganUser.emailVerified) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              ...
              content: Text("Check your email and try again !"),
            ),
          );
        }
      }
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          content: Text("Email or/and Password ERROR !"),
        ),
      );
    }
  }
